  ...
  plugins: [
    ...
    VitePWA({
      ...
      workbox: {
        ...
        // todas as abas antigas fecharem) e a tomar controle das páginas já
        // abertas na hora — sem isso, o PWA pode continuar servindo uma
        // versão em cache mesmo depois de reinstalado, exigindo vários
