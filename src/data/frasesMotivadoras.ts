...
// Extraído do HomePage.tsx: eram 478 das 689 linhas do arquivo, carregadas de
// forma síncrona na primeira tela do app (a Home não é lazy, ao contrário do
// resto das páginas). Como só 1 frase é mostrada por vez, não faz sentido isso
// entrar no bundle inicial — agora fica em chunk próprio, baixado sob demanda
// (ver import dinâmico em HomePage.tsx).
export const FRASES_MOTIVADORAS: Frase[] = [
