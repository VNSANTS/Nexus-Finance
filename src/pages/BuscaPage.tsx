...
import { Search, BookMarked, Calculator, GraduationCap, LineChart, Wallet, BookOpen, type LucideIcon } from 'lucide-react'
import { MODULOS, TRILHAS } from '@banco-de-dados/modulos'
import { GLOSSARIO_TERMOS } from '@banco-de-dados/glossario/termos'
import { LIVROS_META } from '@banco-de-dados/livros'
...
export default function BuscaPage() {
  ...
  const r = useMemo(
    () => ({
      ...
      livros: filtrar(LIVROS_META, q, (l) => [l.titulo, l.autor]),
...
function Secao({ titulo, icone: Icone, cor, children }: { titulo: string; icone: LucideIcon; cor: string; children: React.ReactNode }) {
  return (
